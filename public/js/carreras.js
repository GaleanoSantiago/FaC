...
const generarContenido = ()=> {
    ...
    header.style.background = `linear-gradient(rgba(5,7,8, 0.4), rgba(5,7,8, 0.4)), url(/img/${carreras[id].fondo})`;
    ...
    imgPlan.src=`/img/${carreras[id].planEstudio}`;
    ...
    downloadBtn.href=`/img/${carreras[id].planEstudio}`;
